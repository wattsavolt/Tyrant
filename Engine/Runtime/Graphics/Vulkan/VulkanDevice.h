...
namespace tyr
{
	...
	private:
		...
		LocalObjectPool<DescriptorSet, c_MaxDescriptorSets> m_DescriptorSetPool;
	...
	public:
		...
		{
			return m_BufferViewPool[handle.h];
		}
		...
		{
			return m_ImageViewPool[handle.h];
		}
		...
		{
			return m_RenderPassPool[handle.h];
		}
		...
		{
			return m_GraphicsPipelinePool[handle.h];
		}
		...
		{
			return m_ComputePipelinePool[handle.h];
		}
		...
		{
			return m_RayTracingPipelinePool[handle.h];
		}
		...
		{
			return m_AccelerationStructurePool[handle.h];
		}
		...
		{
			return m_DescriptorPoolPool[handle.h];
		}
		...
		{
			return m_DescriptorSetLayoutPool[handle.h];
		}
		...
		TYR_FORCEINLINE	const DescriptorSet& GetDescriptorSet(DescriptorSetHandle handle) const
		{
			return m_DescriptorSetPool[handle.h];
		}

		TYR_FORCEINLINE	DescriptorSet& GetDescriptorSet(DescriptorSetHandle handle)
		{
			return m_DescriptorSetPool[handle.h];
		}
		...
		{
			return m_SemaphorePool[handle.h];
		}
		...
		{
			return m_ShaderModulePool[handle.h];
		}
