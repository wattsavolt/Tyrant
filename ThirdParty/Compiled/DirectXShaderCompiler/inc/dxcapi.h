...
/// \brief Version of DxcCreateInstance that takes an IAlloc interface.
///
...
struct IDxcLibrary : public IUnknown {
  /// \deprecated
  virtual HRESULT STDMETHODCALLTYPE SetAlloc(_In_opt_ IAlloc *pAlloc) = 0;
  ...
  /// \deprecated 
  virtual HRESULT STDMETHODCALLTYPE CreateBlobWithEncodingOnAlloc(
    _In_bytecount_(size) LPCVOID pText, IAlloc *pIAlloc, UINT32 size, UINT32 codePage,
    _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding) = 0;
...
struct IDxcUtils : public IUnknown {
  ...
  /// \param pData Pointer to buffer containing the contents of the new blob.
  ///
  /// \param pIAlloc The memory allocator to use.
  ///
  ...
  /// the newly created blob.
  ///
  /// This replaces IDxcLibrary::CreateBlobWithEncodingOnAlloc.
  virtual HRESULT STDMETHODCALLTYPE MoveToBlob(
    _In_bytecount_(size) LPCVOID pData, IAlloc *pIAlloc, UINT32 size, UINT32 codePage,
    _COM_Outptr_ IDxcBlobEncoding **ppBlobEncoding) = 0;
